...
// Contains the brand logo, institution selector, and all action controls.
// No business logic — all actions are callbacks from App.jsx.
    ...
    <div className="brand-logo" aria-label="NG CGPA home">
      <span className="brand-logo__icon" aria-hidden="true">
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
          ...
          <path
            d="M5 18 L14 10 L23 18"
            stroke="var(--color-accent)"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <rect x="9" y="18" width="10" height="6" rx="1.5"
            fill="var(--color-accent)" opacity="0.85" />
          <rect x="13" y="8" width="2" height="3" rx="1"
...
function HeaderActions({
  ...
  return (
    <div className="header-actions">
      ...
      {/* Import courses (text/CSV paste) — hidden on mobile, available in data menu */}
      <button
...
// ── Data menu (export + import JSON + clear) ──────────────────────────────────
      ...
      {open && (
        ...
        >
          ...
          <MenuItem
            ...
            description="For WhatsApp or email"
          ...
          {/* Import courses (text paste) — always visible here, primary on mobile */}
          <MenuItem
            icon={<IconImport />}
...
// ── Icons ─────────────────────────────────────────────────────────────────────
// All icons are simple inline SVGs at 16×16.
...
function IconHelp() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
      ...
      <path
        d="M6.2 6.2a1.8 1.8 0 0 1 3.5.6c0 1.2-1.7 1.8-1.7 3"
...
function IconDownload() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
      ...
      />
      <path
        d="M8 2.5v7M5.5 6.5 8 9.5l2.5-3"
        stroke="currentColor" strokeWidth="1.4"
        strokeLinecap="round" strokeLinejoin="round"
      />
    </svg>
...
function IconPDF() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
      ...
      <path d="M5 5.5h4M5 8h6M5 10.5h3.5"
        stroke="currentColor" strokeWidth="1.3"
        strokeLinecap="round" />
    </svg>
  );
...
function IconUpload() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
      ...
      />
      <path
        d="M8 9.5v-7M5.5 5 8 2.5 10.5 5"
        stroke="currentColor" strokeWidth="1.4"
        strokeLinecap="round" strokeLinejoin="round"
      />
    </svg>
  ...
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
      <path d="M2.5 4.5h11M6 4.5V3a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v1.5"
        ...
        strokeLinecap="round" strokeLinejoin="round" />
      <path
        d="M4 4.5l.7 8.5a1 1 0 0 0 1 .9h4.6a1 1 0 0 0 1-.9L12 4.5"
        stroke="currentColor" strokeWidth="1.3"
        strokeLinecap="round" strokeLinejoin="round"
      />
